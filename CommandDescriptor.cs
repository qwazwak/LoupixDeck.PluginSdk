...
/// <summary>
/// A single positional command parameter: its name and CLR type.
/// </summary>
...
/// <summary>
/// Declarative description of a plugin command.
/// </summary>
/// <remarks>
/// <para>
/// The <see cref="CommandName"/> is the stable
...
/// </para>
/// Replaces the core's <c>[Command]</c> attribute.
/// </remarks>
public sealed class CommandDescriptor
{
    /// <summary>
    /// Stable command identifier, e.g. <c>System.ObsStartRecord</c>.
    /// </summary>
    public required string CommandName { get; init; }

    /// <summary>
    /// Label shown in the command-selection menu.
    /// </summary>
    public required string DisplayName { get; init; }

    /// <summary>
    /// Group/category the command is listed under in the menu.
    /// </summary>
    public required string Group { get; init; }

    /// <summary>
    /// Parameter placeholder template, e.g. <c>({SceneName})</c>.
    /// <see langword="null"/> when the command takes no parameters.
    /// </summary>
    public string? ParameterTemplate { get; init; }

    /// <summary>
    /// Positional parameter definitions, in declaration order.
    /// </summary>
